...
<table>
    <tr>
      <td class="title"><h2>Tambah Data Dokter</h2></td>
    </tr>
  </table>
      <form action="<?=site_url('/admin/dokter_add_go')?>" method="post">
        <div class="form-group">
          <label for="nama">Nama Dokter:</label>
          <input name="nama_dokter" type="text" class="form-control" id="nama" placeholder="Masukkan nama....">
        </div>
        <div class="form-group">
